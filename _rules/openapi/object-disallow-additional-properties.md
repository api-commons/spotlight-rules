...
slug: object-disallow-additional-properties
title: Object Disallow Additional Properties
severity: warn
...
description: 'By default, jsonschema allows additionalProperties. This means
  ...
  ``` - no additionalProperties - constrained additionalProperties. It requires
  the `additionalProperties` field to be absent or empty (evaluated at
  `$.[?(@.type=="object" && @.additionalProperties==true)]`). Severity: warn.'
experience:
  - security
  - data-modeling
spec:
