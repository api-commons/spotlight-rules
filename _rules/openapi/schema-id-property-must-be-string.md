...
slug: schema-id-property-must-be-string
...
prompt: "You are editing an OpenAPI document to satisfy the Spotlight API
  governance rule 'schema-id-property-must-be-string' (Schema ID Property Must
  Be String). Requirement: id SHOULD use a data type of 'string'. To fix: Ensure
  ...
  === \"id\")].type` — inspect every location it matches and correct only what
...
builtin: false
ruleyaml: >
  schema-id-property-must-be-string:
    title: Schema ID Property Must Be String
    reference: https://spotlight-rules.com/spec/rules/openapi/schema-id-property-must-be-string/
    description: id SHOULD use a data type of 'string'.
    message: id SHOULD use a data type of 'string'.
    ...
    prompt: "You are editing an OpenAPI document to satisfy the Spotlight API
      governance rule 'schema-id-property-must-be-string' (Schema ID Property Must
      Be String). Requirement: id SHOULD use a data type of 'string'. To fix:
      ...
      `$..[?(@property === \"id\")].type` — inspect every location it matches and
