...
slug: success-response-require-ratelimit-headers
title: Success Response Require Ratelimit Headers
severity: warn
...
description: 'Ratelimiting API preserves a service and limits attack scenario
  ...
  It requires exactly one of ["X-RateLimit-Limit","RateLimit-Limit"] to be
  present, and requires exactly one of
  ["X-RateLimit-Remaining","RateLimit-Remaining"] to be present, and requires
  exactly one of ["X-RateLimit-Reset","RateLimit-Reset"] to be present
  (evaluated at `$.[responses][?(@property[0] == "2" )][headers]`). Severity:
  warn.'
experience:
  - reliability
  - security
