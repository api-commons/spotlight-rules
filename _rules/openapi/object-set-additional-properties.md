...
slug: object-set-additional-properties
title: Object Set Additional Properties
severity: warn
...
description: 'By default, jsonschema allows additionalProperties. This means
  ...
  the `additionalProperties` field to be defined (evaluated at
  `$.[?(@.type=="object" && ! @.additionalProperties)]`). Severity: warn.'
experience:
  - security
  - data-modeling
spec:
