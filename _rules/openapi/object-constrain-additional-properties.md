...
slug: object-constrain-additional-properties
title: Object Constrain Additional Properties
severity: warn
...
description: 'By default, jsonschema allows additionalProperties. This means
  ...
  the `maxProperties` field to be defined (evaluated at `$.[?(@.type=="object"
  && @.additionalProperties &&  @.additionalProperties!=true
  &&  @.additionalProperties!=false )]`). Severity: warn.'
experience:
  - security
  - data-modeling
spec:
