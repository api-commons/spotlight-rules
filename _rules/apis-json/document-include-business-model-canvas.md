...
slug: document-include-business-model-canvas
...
prompt: "You are editing an APIs.json document to satisfy the Spotlight API
  governance rule 'document-include-business-model-canvas' (Document Include
  Business Model Canvas). Requirement: This ensures that an API has had the
  APIOps Business Model Canvas applied to the API, requiring that the canvas is
  ...
  the regular expression `\\b(APIOpsBusinessModelCanvas)\\b`; rename or rewrite
...
ruleyaml: >
  document-include-business-model-canvas:
    ...
    prompt: "You are editing an APIs.json document to satisfy the Spotlight API
      governance rule 'document-include-business-model-canvas' (Document Include
      Business Model Canvas). Requirement: This ensures that an API has had the
      APIOps Business Model Canvas applied to the API, requiring that the canvas
      ...
      match the regular expression `\\b(APIOpsBusinessModelCanvas)\\b`; rename or
