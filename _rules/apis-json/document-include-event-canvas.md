...
slug: document-include-event-canvas
...
prompt: "You are editing an APIs.json document to satisfy the Spotlight API
  governance rule 'document-include-event-canvas' (Document Include Event
  Canvas). Requirement: This ensures that an API has had the APIOps Event Canvas
  ...
  `\\b(APIOpsEventCanvas)\\b`; rename or rewrite any value that does. This rule
...
ruleyaml: >
  document-include-event-canvas:
    ...
    prompt: "You are editing an APIs.json document to satisfy the Spotlight API
      governance rule 'document-include-event-canvas' (Document Include Event
      Canvas). Requirement: This ensures that an API has had the APIOps Event
      ...
      expression `\\b(APIOpsEventCanvas)\\b`; rename or rewrite any value that
